...
##Pmod Header JD
##IO_L5N_T0_34
set_property PACKAGE_PIN T15 [get_ports {phy1_rx[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {phy1_rx[1]}]

##IO_L5P_T0_34
set_property PACKAGE_PIN T14 [get_ports {phy1_tx[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {phy1_tx[0]}]
...
##IO_L11N_T1_SRCC_34
set_property PACKAGE_PIN U15 [get_ports {phy1_rx[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {phy1_rx[0]}]
...
##IO_L21N_T3_DQS_34
set_property PACKAGE_PIN V18 [get_ports {phy1_tx[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {phy1_tx[1]}]
